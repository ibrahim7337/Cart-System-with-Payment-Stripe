        ...
        @if(session('cart'))
            ...
            @php $total += intval($details['price']) * intval($details['quantity']) @endphp
                <tr data-id="{{ $id }}">
                    ...
                    <td data-th="Subtotal" class="text-center">${{ intval($details['price']) * $details['quantity'] }}</td>
        ...
        <tr>
            <td colspan="5" style="text-align: right">
                <form action="/session" method="post">
                    ...
                    <button class="btn btn-success" type="submit" id="chechout-live-button"><i class="fa fa-money"></i> checkout</button>
                </form>
            </td>
        </tr>
    </tfoot>
